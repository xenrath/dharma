...
class JurnalController extends Controller
{
    ...
    public function create()
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('operator.jurnal.create', compact('jenis_jurnals', 'dosens'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('operator/jurnal');
    }
    ...
    public function edit($id)
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('operator.jurnal.edit', compact('jurnal', 'jenis_jurnals', 'dosens'));
    }
