...
class LuaranController extends Controller
{
    ...
    public function create()
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('operator.luaran.create', compact('jenis_luarans', 'dosens'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('operator/luaran');
    }
    ...
    public function edit($id)
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('operator.luaran.edit', compact('luaran', 'jenis_luarans', 'dosens'));
    }
