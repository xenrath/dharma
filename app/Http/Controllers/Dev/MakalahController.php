...
class MakalahController extends Controller
{
    ...
    {
        $makalahs = Makalah::paginate(10);
        // 
        return view('dev.makalah.index', compact('makalahs'));
    }
    ...
    public function create()
    {
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('dev.makalah.create', compact('dosens'));
    }
    ...
    public function edit($id)
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('dev.makalah.edit', compact('makalah', 'dosens'));
    }
