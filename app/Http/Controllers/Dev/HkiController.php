...
class HkiController extends Controller
{
    public function index()
    {
        $hkis = Hki::select(
            ...
            ->paginate(10);
        // 
        return view('dev.hki.index', compact('hkis'));
    }
    ...
    public function create()
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('dev.hki.create', compact('jenis_hkis', 'dosens'));
    }
    ...
    public function edit($id)
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('dev.hki.edit', compact('hki', 'jenis_hkis', 'dosens'));
    }
