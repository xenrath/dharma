...
class ProposalPengabdianController extends Controller
{
    ...
    {
        $proposals = Proposal::where('jenis', 'pengabdian')
        ...
        return view('dosen.proposal.pengabdian.index', compact('proposals'));
    }
    ...
    public function create()
    {
        ...
        return view('dosen.proposal.pengabdian.create', compact('jenis_pendanaans', 'dosens'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $message .= "----------------------------------"  . PHP_EOL;
        $message .= "*" . auth()->user()->nama . "* " . "mengajukan sebuah proposal pengabdian" . PHP_EOL;
        $message .= "----------------------------------"  . PHP_EOL;
        $message .= "Lihat daftar proposal pengabdian" . PHP_EOL;
        $message .= url('operator/proposal-pengabdian');
    ...
    public function edit($id)
    {
        ...
        return view('dosen.proposal.pengabdian.edit', compact('proposal', 'jenis_pendanaans', 'dosens'));
    }
