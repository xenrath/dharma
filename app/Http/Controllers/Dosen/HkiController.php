...
class HkiController extends Controller
{
    ...
    {
        $hkis = Hki::where('user_id', auth()->user()->id)
            ->orWhereHas('jurnal_personels', function ($query) {
            ...
            ->with('user:id,nama')
            ->with('hki_pesonels', function ($query) {
                $query->select('hki_id', 'user_id');
                $query->with('user:id,nama');
            })
            ->paginate(10);
        // 
        return view('dosen.hki.index', compact('hkis'));
    }
    ...
    public function create()
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('dosen.hki.create', compact('jenis_hkis', 'dosens'));
    }
    ...
    public function edit($id)
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('dosen.hki.edit', compact('hki', 'jenis_hkis', 'dosens'));
    }
