...
class JurnalController extends Controller
{
    ...
    public function create()
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('dosen.jurnal.create', compact('jenis_jurnals', 'dosens'));
    }
    ...
    public function edit($id)
    {
        ...
        $dosens = User::where('role', 'dosen')
            ...
            ->get();
        // 
        return view('dosen.jurnal.edit', compact('jurnal', 'jenis_jurnals', 'dosens'));
    }

    public function update(Request $request, $id)
    {
        if (Jurnal::where('id', $id)->value('user_id') != auth()->user()->id) {
