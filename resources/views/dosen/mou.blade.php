...
<body>
    ...
    <span style="display: block;">
        ...
        Pelaksanaan {{ $jenis }} seluruhnya sebesar @rupiah($proposal->dana_usulan),- ({{ $dana_terbilang }}) yang
        dibebankan pada
    ...
    <table>
        <tr>
            <td style="width: 20px; vertical-align: top;">1.</td>
            <td>Tahap I sebesar 75% dari @rupiah($proposal->dana_usulan),- ({{ $dana_terbilang }}) yaitu @rupiah($tahap_pertama),-
                ({{ $tahap_pertama_terbilang }}) diberikan setelah penandatanganan perjanjian kerjasama ini.</td>
        </tr>
        <tr>
            <td style="width: 20px; vertical-align: top;">2.</td>
            <td>
                Tahap II sebesar 25% dari @rupiah($proposal->dana_usulan),- ({{ $dana_terbilang }}) yaitu @rupiah($tahap_kedua),-
