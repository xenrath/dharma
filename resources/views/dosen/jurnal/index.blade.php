                ...
                <div class="card rounded-0">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <a href="{{ url('dosen/jurnal/create') }}" class="btn btn-primary btn-sm btn-flat">
                                Tambah Jurnal
                            </a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if ($jurnal->user_id == auth()->user()->id)
                                                    <a href="{{ url('dosen/jurnal/' . $jurnal->id . '/edit') }}"
        ...
        <div class="modal fade" id="modal-hapus-{{ $jurnal->id }}">
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        Yakin hapus jurnal dengan judul <strong>{{ $jurnal->judul }}</strong>?
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default btn-sm btn-flat"
                            data-dismiss="modal">Tutup</button>
                        <form action="{{ url('dosen/jurnal/' . $jurnal->id) }}" method="POST">
                            @csrf
                            @method('delete')
