...
@section('title', 'Tambah Makalah Ilmiah')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('dosen/makalah') }}" class="btn btn-secondary btn-flat float-left mr-2">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1>Tambah Makalah Ilmiah</h1>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('dosen/makalah') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card rounded-0">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="forum" name="forum" value="{{ old('forum') }}">
                                        @error('forum')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="custom-select rounded-0 @error('status') is-invalid @enderror"
                                            ...
                                            <option value="">- Pilih -</option>
                                            <option value="biasa" {{ old('status') == 'biasa' ? 'selected' : '' }}>
                                                Pemalakah Biasa
                                            </option>
                                            <option value="spesial" {{ old('status') == 'spesial' ? 'selected' : '' }}>
                            ...
                            <div class="form-group mb-2">
                                <label for="file">File Makalah</label>
                    ...
                    <div class="text-right pb-4">
                        <button type="submit" class="btn btn-primary btn-sm btn-flat">Tambah Makalah Ilmiah</button>
                    </div>
                </form>
            </div>
        </section>
