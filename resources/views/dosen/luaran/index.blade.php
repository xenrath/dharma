                ...
                <div class="card rounded-0">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <a href="{{ url('dosen/luaran/create') }}" class="btn btn-primary btn-sm btn-flat">
                                Tambah Luaran
                            </a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @forelse ($luarans as $key => $luaran)
                                        <tr>
                                            ...
                                            <td>
                                                <strong>{{ $luaran->jenis_luaran->nama }}</strong>
                                                <br>
                                                {{ $luaran->judul }}
                                                <br>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if ($luaran->user_id == auth()->user()->id)
                                                    <a href="{{ url('dosen/luaran/' . $luaran->id . '/edit') }}"
        ...
        <div class="modal fade" id="modal-hapus-{{ $luaran->id }}">
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        Yakin hapus Luaran dengan judul <strong>{{ $luaran->judul }}</strong>?
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default btn-sm btn-flat"
                            data-dismiss="modal">Tutup</button>
                        <form action="{{ url('dosen/luaran/' . $luaran->id) }}" method="POST">
                            @csrf
                            @method('delete')
