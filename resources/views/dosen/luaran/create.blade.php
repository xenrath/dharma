...
@section('title', 'Tambah Luaran Lainnya')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('dosen/luaran') }}" class="btn btn-secondary btn-flat float-left mr-2">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1>Tambah Luaran Lainnya</h1>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('dosen/luaran') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                        ...
                        <div class="card-body">
                                        ...
                                        <select
                                            ...
                                            @foreach ($jenis_luarans as $jenis_luaran)
                                                <option value="{{ $jenis_luaran->id }}"
                                                    {{ old('jenis_luaran_id') == $jenis_luaran->id ? 'selected' : '' }}>
                                                    {{ $jenis_luaran->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control rounded-0 @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi"
                                    cols="30" rows="4">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-2">
                                <label for="file">File Lainnya</label>
                    ...
                    <div class="text-right pb-4">
                        <button type="submit" class="btn btn-primary btn-sm btn-flat">Tambah Luaran Lainnya</button>
                    </div>
                </form>
            </div>
        </section>
