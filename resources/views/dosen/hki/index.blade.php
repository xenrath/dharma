                ...
                <div class="card rounded-0">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <a href="{{ url('dosen/hki/create') }}" class="btn btn-primary btn-sm btn-flat">
                                Tambah HKI
                            </a>
                        </div>
                    </div>
                                    ...
                                    @forelse ($hkis as $key => $hki)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ url('dosen/hki/' . $hki->id . '/edit') }}"
        ...
        <div class="modal fade" id="modal-hapus-{{ $hki->id }}">
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        Yakin hapus HKI dengan judul <strong>{{ $hki->judul }}</strong>?
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default btn-sm btn-flat"
                            data-dismiss="modal">Tutup</button>
                        <form action="{{ url('dosen/hki/' . $hki->id) }}" method="POST">
                            @csrf
                            @method('delete')
