    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('dosen/hki') }}" class="btn btn-secondary btn-flat float-left mr-2">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('dosen/hki/' . $hki->id) }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="user_id" name="user_id" value="{{ $hki->user->nama }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="number"
                                            ...
                                            id="tahun" name="tahun" value="{{ old('tahun', $hki->tahun) }}">
                                        @error('tahun')
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control rounded-0 @error('judul') is-invalid @enderror" name="judul" id="judul"
                                    cols="30" rows="4">{{ old('judul', $hki->judul) }}</textarea>
                                @error('judul')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="nomor" name="nomor" value="{{ old('nomor', $hki->nomor) }}">
                                        @error('nomor')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <select class="custom-select rounded-0 @error('jenis_hki_id') is-invalid @enderror"
                                            ...
                                            @foreach ($jenis_hkis as $jenis_hki)
                                                <option value="{{ $jenis_hki->id }}"
                                                    {{ old('jenis_hki_id', $hki->jenis_hki_id) == $jenis_hki->id ? 'selected' : '' }}>
                                                    {{ $jenis_hki->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('pendaftaran', $hki->pendaftaran) }}">
                                        @error('pendaftaran')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="custom-select rounded-0 @error('status') is-invalid @enderror"
                                            ...
                                            <option value="terdaftar"
                                                {{ old('status', $hki->status) == 'terdaftar' ? 'selected' : '' }}>
                                                Terdaftar
                                            </option>
                                            <option value="granted"
                                                {{ old('status', $hki->status) == 'granted' ? 'selected' : '' }}>
                                                Granted
                                            </option>
                                        </select>
                                        @error('status')
                    ...
                    <div class="text-right pb-4">
                        <button type="submit" class="btn btn-primary btn-sm btn-flat">Edit HKI</button>
                    </div>
                </form>
            </div>
        </section>
...
@section('script')
    <script>
        ...
        // 
        var personels = @json(old('personels', $hki->hki_personels->pluck('user_id')));
        if (personels !== null) {
