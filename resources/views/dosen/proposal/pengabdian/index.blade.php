                ...
                <div class="card rounded-0">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <a href="{{ url('dosen/proposal-pengabdian/create') }}" class="btn btn-primary btn-sm btn-flat">
                                Tambah
                            </a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if ($proposal->user_id == auth()->user()->id && $proposal->status == 'menunggu')
                                                    <a href="{{ url('dosen/proposal-pengabdian/' . $proposal->id . '/edit') }}"
        ...
        <div class="modal fade" id="modal-hapus-{{ $proposal->id }}">
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        Yakin hapus Proposal Pengabdian dari <strong>{{ $proposal->user->nama }}</strong>?
                    </div>
                    <div class="modal-footer justify-content-between">
