    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('dosen/proposal-penelitian') }}" class="btn btn-secondary btn-flat float-left mr-2">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('dosen/proposal-penelitian') }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
