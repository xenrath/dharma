                ...
                <div class="card rounded-0">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <a href="{{ url('dosen/buku/create') }}" class="btn btn-primary btn-sm btn-flat">
                                Tambah Buku
                            </a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if ($buku->user_id == auth()->user()->id)
                                                    <a href="{{ url('dosen/buku/' . $buku->id . '/edit') }}"
        ...
        <div class="modal fade" id="modal-hapus-{{ $buku->id }}">
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        Yakin hapus buku ajar dengan judul <strong>{{ $buku->judul }}</strong>?
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default btn-sm btn-flat"
                            data-dismiss="modal">Tutup</button>
                        <form action="{{ url('dosen/buku/' . $buku->id) }}" method="POST">
                            @csrf
                            @method('delete')
