...
@section('content')
    <div class="content-wrapper">
        <div class="content-header">
            <div class="mb-2">
                <h1>LPPM - Statistik Pengabdian SIDHARMA</h1>
                <span class="text-muted">Halaman Informasi Statistik Pengabdian LPPM Universitas Bhamada
                    Slawi</span>
            </div>
        </div>
            ...
            <div class="card rounded-0">
                ...
                <div class="card-body">
                    <div class="row mb-2 justify-content-start">
                        <div class="col-md-3">
                            <form action="{{ url('statistik/pengabdian') }}" method="get" id="form-filter">
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th class="text-center" style="width: 20px;">No</th>
                                    <th>Program Studi</th>
                                    <th style="width: 180px;">Jumlah Pengabdian</th>
                                </tr>
                            </thead>
                            <tbody>
