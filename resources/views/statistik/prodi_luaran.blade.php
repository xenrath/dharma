...
@section('content')
    <div class="content-wrapper">
        <div class="content-header">
            <div class="mb-2">
                <h1>LPPM - Statistik Luaran Lainnya <strong>{{ $prodi->nama }}</strong> SIDHARMA</h1>
                <span class="text-muted">Halaman Informasi Statistik Luaran Lainnya <strong>{{ $prodi->nama }}</strong> LPPM
                    Universitas Bhamada
                    Slawi</span>
            </div>
        </div>
        <div class="content pb-2">
            <div class="card rounded-0">
                <div class="card-header">
                    <h3 class="card-title">
                        Data Luaran Lainnya <strong>{{ $prodi->nama }}</strong>
                                ...
                                <tr>
                                    ...
                                    <th class="align-top" style="width: 200px;">
                                        ...
                                        <small class="text-muted" data-toggle="tooltip" data-placement="top"
                                            title="jumlah dihitung dari makalah yang diikuti dosen"
