...
@section('content')
    <div class="content-wrapper">
        <div class="content-header">
            <div class="mb-2">
                <h1>LPPM - Statistik Pemakalah Forum Ilmiah <strong>{{ $prodi->nama }}</strong> SIDHARMA</h1>
                <span class="text-muted">
                    Halaman Informasi Statistik Pemakalah Forum Ilmiah <strong>{{ $prodi->nama }}</strong> LPPM Universitas
                    Bhamada Slawi
                </span>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <th class="align-top" style="width: 200px;">
                                        ...
                                        <small class="text-muted" data-toggle="tooltip" data-placement="top"
                                            title="jumlah dihitung dari makalah yang diikuti dosen" style="cursor: pointer;">
