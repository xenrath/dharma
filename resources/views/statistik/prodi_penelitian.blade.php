...
@section('content')
    <div class="content-wrapper">
        <div class="content-header">
            <div class="mb-2">
                <h1>LPPM - Statistik Penelitian <strong>{{ $prodi->nama }}</strong> SIDHARMA</h1>
                <span class="text-muted">
                    Halaman Informasi Statistik Penelitian <strong>{{ $prodi->nama }}</strong> LPPM Universitas Bhamada
                    Slawi
                </span>
            </div>
        </div>
            ...
            <div class="card rounded-0">
                ...
                <div class="card-body">
                    <div class="row mb-2 justify-content-start">
                        <div class="col-md-3">
                            <form action="{{ url('statistik/prodi/' . $prodi->id . '/penelitian') }}" method="get"
                                id="form-filter">
                                ...
                                <tr>
                                    ...
                                    <th class="align-top" style="width: 200px;">
                                        ...
                                        <small class="text-muted" data-toggle="tooltip" data-placement="top"
                                            title="jumlah dihitung dari penelitian yang diikuti dosen"
