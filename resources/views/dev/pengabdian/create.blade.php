    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('dev/pengabdian') }}" class="btn btn-secondary btn-flat float-left mr-2">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1>Buat Pengabdian</h1>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('dev/pengabdian') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card rounded-0">
                        <div class="card-header">
                            <h3 class="card-title">Form Pengabdian</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                ...
                                                id="dana_setuju" name="dana_setuju" value="{{ old('dana_setuju') }}">
                                        </div>
                                        @error('dana_setuju')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        <label for="file">Laporan Pengabdian</label>
                                        <input type="file"
                    ...
                    <div class="text-right pb-4">
                        <button type="submit" class="btn btn-primary btn-flat">Buat Pengabdian</button>
                    </div>
                </form>
            </div>
        </section>
