...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('dev/proposal') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="custom-select rounded-0 @error('jenis') is-invalid @enderror"
                                            ...
                                            <option value="">- Pilih -</option>
                                            <option value="penelitian" {{ old('jenis') == 'penelitian' ? 'selected' : '' }}>
                                                Penelitian
                                            </option>
                                            <option value="pengabdian" {{ old('jenis') == 'pengabdian' ? 'selected' : '' }}>
                                                Pengabdian
                                            </option>
                                        </select>
                                        @error('jenis')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="custom-select rounded-0 @error('status') is-invalid @enderror"
                                            ...
                                            <option value="revisi1" {{ old('status') == 'revisi1' ? 'selected' : '' }}>
                                                Revisi 1
                                            </option>
                                            <option value="setuju1" {{ old('status') == 'setuju1' ? 'selected' : '' }}>
                                                Setuju 1
                                            </option>
                                            <option value="revisi2" {{ old('status') == 'revisi2' ? 'selected' : '' }}>
                                                Revisi 2
                                            </option>
                                            <option value="pendanaan" {{ old('status') == 'pendanaan' ? 'selected' : '' }}>
                                                Pendanaan
                                            </option>
                                            <option value="mou" {{ old('status') == 'mou' ? 'selected' : '' }}>
                                                MOU
                                            </option>
                                            <option value="setuju2" {{ old('status') == 'setuju2' ? 'selected' : '' }}>
                                                Setuju 2
                                            </option>
