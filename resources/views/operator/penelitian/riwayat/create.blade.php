...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('operator/penelitian-riwayat') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    ...
                    <div class="text-right pb-4">
                        <button type="submit" class="btn btn-primary btn-flat">Buat Penelitian</button>
                    </div>
                </form>
            </div>
        </section>
