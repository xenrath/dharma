            ...
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body border-top">
                        @if (count($penelitian->penelitian_revisis))
                            @foreach ($penelitian->penelitian_revisis as $key => $penelitian_revisi)
                                <div class="mb-2">
                                    <strong>Revisi {{ count($penelitian->penelitian_revisis) - $key }}</strong>
                                    <br>
