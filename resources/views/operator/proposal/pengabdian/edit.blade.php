...
@section('title', 'Edit Proposal Penelitian')
...
@section('content')
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1>Edit Proposal Penelitian</h1>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('operator/proposal-penelitian/' . $penelitian->id) }}" method="POST"
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('dana_sumber', $penelitian->dana_sumber) }}">
                                        @error('dana_sumber')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('dana_usulan', $penelitian->dana_usulan) }}">
                                        </div>
                                        @error('dana_usulan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ asset('storage/uploads/' . $penelitian->berkas) }}"
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append ">
                                        <button type="button" class="btn btn-secondary btn-flat btn-sm"
                                            data-toggle="modal" data-target="#modal-ketua">Pilih Ketua</button>
                                    </div>
                                    @error('ketua_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
...
@section('script')
    <script>
        ...
        var ketua_id = "{{ old('ketua_id', $penelitian->user_id) }}";
        if (ketua_id) {
            ketua_set(ketua_id);
        }
        ...
        function anggota_set(key, value) {
            var no = key + 1;
            var tbody = '<tr>';
            tbody += '<td class="text-center">' + no + '</td>';
        ...
        var anggota_ids = @json(old('anggota_ids', $penelitian->anggota_ids));
        if (anggota_ids !== null) {
