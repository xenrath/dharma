...
@section('title', 'Proposal Menunggu')
...
@section('content')
                            ...
                            <table class="table table-bordered table-striped mb-4">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-top">Jadwal / Reviewer</th>
                                        <th class="align-top">Proposal</th>
    ...
    @foreach ($proposals as $proposal)
        ...
        <div class="modal fade" id="modal-kembalikan-{{ $proposal->id }}">
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    <div class="modal-header">
                        <h4 class="modal-title">Kembalikan Proposal</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        Yakin kembalikan Proposal {{ $proposal->jenis == 'penelitian' ? 'Penelitian' : 'Pengabdian' }} dari
                        <strong>{{ $proposal->user->nama }}</strong>?
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default btn-sm btn-flat"
                            data-dismiss="modal">Tutup</button>
                        <form action="{{ url('operator/proposal-jadwal/menunggu/' . $proposal->id) }}" method="POST">
                            @csrf
                            @method('POST')
                            <button type="submit" class="btn btn-warning btn-sm btn-flat">Kembalikan</button>
                        </form>
                    </div>
                </div>
            </div>
