    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('operator/buku') }}" class="btn btn-secondary btn-flat float-left mr-2">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1>Edit Buku Ajar</h1>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('operator/buku/' . $buku->id) }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control rounded-0 @error('judul') is-invalid @enderror" name="judul" id="judul"
                                    cols="30" rows="4">{{ old('judul', $buku->judul) }}</textarea>
                                @error('judul')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="number"
                                            ...
                                            id="jumlah" name="jumlah" value="{{ old('jumlah', $buku->jumlah) }}">
                                        @error('jumlah')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                    ...
                    <div class="text-right pb-4">
                        <button type="submit" class="btn btn-primary btn-sm btn-flat">Edit Buku Ajar</button>
                    </div>
                </form>
            </div>
        </section>
...
@section('script')
    <script>
        ...
        // 
        var personels = @json(old('personels', $buku->buku_personels->pluck('user_id')));
        if (personels !== null) {
