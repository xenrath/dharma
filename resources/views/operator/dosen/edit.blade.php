        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card rounded-0">
                    ...
                    <!-- /.card-header -->
                    <form action="{{ url('operator/dosen/' . $dosen->id) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select class="custom-select rounded-0" name="is_peninjau" id="is_peninjau">
                                    <option value="0" {{ old('is_peninjau', $dosen->is_peninjau) ? 'selected' : '' }}>
                                        Tidak</option>
                                    <option value="1" {{ old('is_peninjau', $dosen->is_peninjau) ? 'selected' : '' }}>
                                        Ya</option>
                                </select>
                            </div>
                        </div>
