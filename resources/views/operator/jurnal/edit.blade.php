...
@section('title', 'Edit Publikasi Jurnal')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('operator/jurnal') }}" class="btn btn-secondary btn-flat float-left mr-2">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1>Edit Publikasi Jurnal</h1>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('operator/jurnal/' . $jurnal->id) }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control rounded-0" id="user_id" name="user_id"
                                            value="{{ $jurnal->user->nama }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="number"
                                            ...
                                            id="tahun" name="tahun" value="{{ old('tahun', $jurnal->tahun) }}">
                                        @error('tahun')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="nama" name="nama" value="{{ old('nama', $jurnal->nama) }}">
                                        @error('nama')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <select
                                            ...
                                            @foreach ($jenis_jurnals as $jenis_jurnal)
                                                <option value="{{ $jenis_jurnal->id }}"
                                                    {{ old('jenis_jurnal_id', $jurnal->jenis_jurnal_id) == $jenis_jurnal->id ? 'selected' : '' }}>
                                                    {{ $jenis_jurnal->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control rounded-0 @error('judul') is-invalid @enderror" name="judul" id="judul"
                                    cols="30" rows="4">{{ old('judul', $jurnal->judul) }}</textarea>
                                @error('judul')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="issn" name="issn" value="{{ old('issn', $jurnal->issn) }}">
                                        @error('issn')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="volume" name="volume" value="{{ old('volume', $jurnal->volume) }}">
                                        @error('volume')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="nomor" name="nomor" value="{{ old('nomor', $jurnal->nomor) }}">
                                        @error('nomor')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                ...
                                                id="halaman_awal" name="halaman_awal"
                                                value="{{ old('halaman_awal', $jurnal->halaman_awal) }}">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('halaman_akhir', $jurnal->halaman_akhir) }}">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            id="url" name="url" value="{{ old('url', $jurnal->url) }}">
                                        @error('url')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
...
@section('script')
    <script>
        ...
        // 
        var personels = @json(old('personels', $jurnal->jurnal_personels->pluck('user_id')));
        if (personels !== null) {
        ...
        // 
        var old_mahasiswa = @json(session('old_mahasiswas') ?? $jurnal->mahasiswas);
