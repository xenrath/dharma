                ...
                <div class="card rounded-0">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <a href="{{ url('operator/luaran/create') }}" class="btn btn-primary btn-sm btn-flat">
                                Tambah Luaran
                            </a>
                        </div>
                    </div>
                                    ...
                                    @forelse ($luarans as $key => $luaran)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ url('operator/luaran/' . $luaran->id . '/edit') }}"
                ...
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6">
                                <a href="{{ $luaran->url }}">
                                    <span style="word-wrap: break-word;">{{ $luaran->url }}aaaaaaaaaaaa</span>
                                </a>
                            </div>
                        </div>
                        <div class="row mb-2">
            ...
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default btn-sm btn-flat"
                            data-dismiss="modal">Tutup</button>
                        <form action="{{ url('operator/luaran/' . $luaran->id) }}" method="POST">
                            @csrf
                            @method('delete')
